...
export interface GithubAccessTokenSpecAuth {
   ...
   */
  readonly privatKey: GithubAccessTokenSpecAuthPrivatKey;
...
export function toJson_GithubAccessTokenSpecAuth(obj: GithubAccessTokenSpecAuth | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'privatKey': toJson_GithubAccessTokenSpecAuthPrivatKey(obj.privatKey),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 */
export interface GithubAccessTokenSpecAuthPrivatKey {
  /**
   ...
   */
  readonly secretRef: GithubAccessTokenSpecAuthPrivatKeySecretRef;

}

/**
 * Converts an object of type 'GithubAccessTokenSpecAuthPrivatKey' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_GithubAccessTokenSpecAuthPrivatKey(obj: GithubAccessTokenSpecAuthPrivatKey | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'secretRef': toJson_GithubAccessTokenSpecAuthPrivatKeySecretRef(obj.secretRef),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 */
export interface GithubAccessTokenSpecAuthPrivatKeySecretRef {
  /**
   * The key of the entry in the Secret resource's `data` field to be used. Some instances of this field may be
   * defaulted, in others it may be required.
   *
...
/**
 * Converts an object of type 'GithubAccessTokenSpecAuthPrivatKeySecretRef' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_GithubAccessTokenSpecAuthPrivatKeySecretRef(obj: GithubAccessTokenSpecAuthPrivatKeySecretRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'key': obj.key,
    'name': obj.name,
