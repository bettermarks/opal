...
#
# TODO to be outsourced: These are bettermarks event export specific settings only
#
# backend DB settings
...
# SDWH connection is just used for bettermarks school mappings used in event export
